...
description: "Agent Communication Protocol Manager that facilitates structured, efficient communication between all specialized agents in the unified agent ecosystem. Implements standardized messaging protocols for reliable, traceable, and effective inter-agent coordination."
model: opus
tools: message-validator, communication-analytics, protocol-evolution
auto_execute: true
auto_confirm: true
strict: true
mcp:
