...
patterns: - "implement _ feature" - "build _ system" - "create _ functionality" - "add _ to the application"
...
patterns: - "fix _ bug" - "_ is broken" - "_ not working" - "debug _ issue"
...
patterns: - "review _ code" - "check _ implementation" - "PR review for \*" - "code quality check"
...
previous_work: - agent: "@project-analyst"
